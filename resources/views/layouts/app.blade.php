        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="hidden md:flex md:items-center md:space-x-8">
                    ...
                    <a href="#" class="magnetic-btn group relative bg-primary-500 text-white px-7 py-3 rounded-full text-sm font-medium transition-all duration-300 hover:bg-primary-600 hover:shadow-lg hover:shadow-primary-500/20 overflow-hidden">
