    ...
    <div className="space-y-4 sm:space-y-6 lg:space-y-8 px-3 sm:px-4 lg:px-6">
      ...
      <div className="space-y-3 sm:space-y-4">
        <div className="text-center sm:text-left">
          <h1 className="font-bold text-lg sm:text-xl lg:text-2xl xl:text-3xl text-gray-900 leading-tight">
        ...
        <div className="flex flex-col space-y-2 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-2 lg:space-x-3">
          ...
          <Link
            href="/orders/create"
            className="w-full sm:w-auto inline-flex items-center justify-center px-4 lg:px-6 py-2.5 lg:py-3 bg-gradient-to-r from-blue-700 to-blue-800 border border-transparent rounded-lg font-semibold text-sm lg:text-base text-white hover:from-blue-800 hover:to-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 transform hover:scale-105 transition-all duration-200 shadow-lg"
          >
          ...
          <div className="relative sm:w-auto">
            <button 
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2.5 bg-white border border-gray-300 rounded-lg font-medium text-sm text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200"
            >
            ...
            {quickActionsOpen && (
              <>
                ...
                />
                <div className="absolute left-0 sm:right-0 mt-2 w-full sm:w-56 bg-white rounded-lg shadow-lg border border-gray-200 z-20">
                  <div className="py-2">
      ...
      {/* Health Status Banner - Mobile Optimized */}
      <div className="bg-gradient-to-br from-blue-50 via-blue-100 to-indigo-50 rounded-xl sm:rounded-2xl shadow-sm overflow-hidden relative">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600/10 to-indigo-600/10"></div>
        <div className="relative px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="space-y-4">
            {/* Profile Section */}
            <div className="flex items-start space-x-3 sm:space-x-4">
              <div className="h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 rounded-full bg-gradient-to-r from-blue-600 to-blue-700 flex items-center justify-center shadow-lg flex-shrink-0">
            ...
            {stats && stats.activeOrders > 0 && (
              <div className="p-3 sm:p-4 bg-white/80 rounded-lg backdrop-blur-sm border border-white/20">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-shrink-0">
                    <Link href="/orders" className="text-xs sm:text-sm font-medium text-blue-600 hover:text-blue-700 transition-colors whitespace-nowrap">
                      View →
                    </Link>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3 lg:gap-4 pt-2">
              <div className="text-center p-3 sm:p-4 bg-white/80 rounded-lg sm:rounded-xl backdrop-blur-sm border border-white/20">
                <div className="text-lg sm:text-xl lg:text-2xl font-bold text-blue-600">{stats?.totalOrders || 0}</div>
                <div className="text-xs text-gray-600 uppercase tracking-wide mt-1">Total Orders</div>
              </div>
              <div className="text-center p-3 sm:p-4 bg-white/80 rounded-lg sm:rounded-xl backdrop-blur-sm border border-white/20">
                <div className="text-lg sm:text-xl lg:text-2xl font-bold text-green-600">{stats?.completedOrders || 0}</div>
        ...
        <div className="bg-white shadow-sm sm:shadow rounded-lg sm:rounded-xl overflow-hidden">
          ...
          <div className="divide-y divide-gray-100">
            {recentOrders.slice(0, 5).map((order) => (
              <div key={order.id} className="px-4 sm:px-6 py-3 sm:py-4 hover:bg-gray-50 active:bg-gray-100 transition-colors">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-1 sm:space-y-0">
                      ...
                      <div className="flex-shrink-0">
                        <span className={`inline-flex px-2 sm:px-3 py-1 text-xs font-semibold rounded-full capitalize whitespace-nowrap ${
